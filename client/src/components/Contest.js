...
const Hero = () => {
  ...
  <div className="prob-stand-nav">
    ...
    <label htmlFor="tab1" style={{paddingLeft: 0}}>Problems</label>
    <input id="tab2" type="radio" name="tabs" />
    <label htmlFor="tab2" style={{paddingLeft: 0}}>Standings</label>
    <button className="waves-effect waves-light btn update-table">Update</button>
  </div>
